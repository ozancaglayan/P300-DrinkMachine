function deneme001(times,runs,ftime,noftime,samplerate)
 ...
 bcolor  = [0 0 0];
    ...
    ipA = '10.1.1.93'; portA = 9090;portA2=9092; 
    ipB = '10.1.2.205'; portB = 9091;portB2=9093; 
...
result=str2num(fscanf(udpA2))

if (result == 1)
Screen('DrawText', w, 'your choice is:', 100, 100, tcolor);
Screen('DrawText', w, 'water', 100, 140, tcolor);
Screen('Flip',w);
end    
if (result == 2)
Screen('DrawText', w, 'your choice is:', 100, 100, tcolor);
Screen('DrawText', w, 'coffee', 100, 140, tcolor);
Screen('Flip',w);
end    
if (result == 3)
Screen('DrawText', w, 'your choice is:', 100, 100, tcolor);
Screen('DrawText', w, 'tea', 100, 140, tcolor);
Screen('Flip',w);
end    
if (result == 4)
Screen('DrawText', w, 'your choice is:', 100, 100, tcolor);
Screen('DrawText', w, 'soda', 100, 140, tcolor);
Screen('Flip',w);
end    
if (result == 5)
Screen('DrawText', w, 'your choice is:', 100, 100, tcolor);
Screen('DrawText', w, 'beer', 100, 140, tcolor);
Screen('Flip',w);
end    
