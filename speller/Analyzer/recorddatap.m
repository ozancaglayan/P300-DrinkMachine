...
try
    ...
    % These are coming from the other computer
    ...
    % Compute recordtime and samplestorecord
    recordtime=(6*(xftime+yftime+noftime+noftime))*times+5 %1 saniye baþta 3 sn sonda ekle (grafik gecýkmeleri)
    ...
    for i = 1:runs
        ...
        fprintf(1, 'startMPAcqDaemon returned.');
        ...
        fprintf(1, 'startAcquisition returned.');
        if ~strcmp(retval,'MPSUCCESS')
        ...
        for j = 1:times
            ...
            cue1 = [cue1, int32(cuedatanum(3:14)*200)]
